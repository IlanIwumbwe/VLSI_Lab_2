##   Mask layers of the invertor
`NW` : n-well
`NP`: n+ diffusion
`PP`: p+ diffusion
`CO`: contact hole mask
`M1`: metal mask 
`PO`: polysilicon gate mask
`OD` : oxide layer?

## Extracting circuit from layout
...
<img width="1104" height="159" alt="image" src="https://github.com/user-attachments/assets/6614ae1a-ed86-475b-bfe0-938a48f856e5" />

via height 0.1
via width 0.1

<img width="165" height="159" alt="image" src="https://github.com/user-attachments/assets/c26667d7-6057-40ea-afaa-8fe3b114d106" />
...
REPORT FILE NAME:         lfsr4.lvs.report
LAYOUT NAME:              /home/ck622/lfsr4.sp ('lfsr4')
SOURCE NAME:              _source.net_ ('lfsr4')
RULE FILE:                /home/ck622/_calibre.lvs_
CREATION TIME:            Thu Oct 16 18:06:47 2025
CURRENT DIRECTORY:        /home/ck622
USER NAME:                ck622
CALIBRE VERSION:          v2018.4_17.10    Wed Oct 3 17:09:05 PDT 2018
...
o LVS Setup:
   ...
   LVS POWER NAME                         "AHVDD" "AHVDDB" "AHVDDG" "AHVDDR" "AHVDDWELL" "AVDD" "AVDDB" "AVDDBG" "AVDDG" "AVDDR"
   ...
   LVS GROUND NAME                        "AGND" "AHVSS" "AHVSSB" "AHVSSG" "AHVSSR" "AHVSSUB" "AVSS" "AVSSB" "AVSSBG" "AVSSG"
                                          "AVSSR" "AVSSUB" "DHVSS" "DVSS" "GND" "HVSSUB" "TAVSS" "TAVSSPST" "TVSS" "VS33" "VSS"
                                          "VSSESD" "VSSG" "VSSM" "VSSPST" "VSSUB"
   LVS CELL SUPPLY                        NO
   ...
   LVS DEVICE TYPE                        RESISTOR "rm1" "rm10" "rm2" "rm3" "rm4" "rm5" "rm6" "rm7" "rm8" "rm9" "rnodl" "rnodl_m"
                                                   "rnods" "rnods_m" "rnodwo" "rnodwo_m" "rnpolyl" "rnpolyl_m" "rnpolys"
                                                   "rnpolys_m" "rnpolywo" "rnpolywo_m" "rnwod" "rnwod_m" "rnwsti" "rnwsti_m"
                                                   "rpodl" "rpodl_m" "rpods" "rpods_m" "rpodwo" "rpodwo_m" "rppolyl" "rppolyl_m"
                                                   "rppolyl_rf" "rppolyl_rf_rdk" "rppolys" "rppolys_m" "rppolys_rf"
                                                   "rppolys_rf_rdk" "rppolywo" "rppolywo_m" "rppolywo_rf" "rppolywo_rf_rdk"
...
LAYOUT CELL NAME:         lfsr4
SOURCE CELL NAME:         lfsr4
...
<img width="1794" height="1119" alt="image" src="https://github.com/user-attachments/assets/ee9702a4-da44-43e8-a632-fe574aff4a0b" />
